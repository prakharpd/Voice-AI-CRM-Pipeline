# Agentic AI Voice Lead Qualification
## About This Project

It is a fully local AI powered end-to end system that automates the process of qualifying sales leads. It replaces the manual work of calling prospects and asking them questions by running an automated voice session directly in the browser. The system handles everything from collecting lead details to scoring them (based on Setiment Analysis) and alerting the sales team without any human involvement in between.
